...
public class Const {
    ...
    public static final String SECTION_NOT_FOUND = "There are something wrong in your YML config file, plugin could not find section '%s', please fix the issue or delete the file.";
